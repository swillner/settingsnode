...
add_library(settingsnode STATIC IMPORTED)
...
if(EXISTS ${CMAKE_CURRENT_LIST_DIR}/lib/yaml-cpp/CMakeLists.txt)
  ...
  set(SETTINGSNODE_INCLUDE_DIR ${CMAKE_CURRENT_LIST_DIR}/lib/yaml-cpp/include ${CMAKE_CURRENT_LIST_DIR}/include)
  set(SETTINGSNODE_LIBRARY ${CMAKE_CURRENT_BINARY_DIR}/yaml-cpp/libyaml-cpp.a)
else()
  ...
  set(SETTINGSNODE_INCLUDEDIR ${YAML_CPP_INCLUDE_DIR} ${CMAKE_CURRENT_LIST_DIR}/include)
  set(SETTINGSNODE_LIBRARY ${YAML_CPP_LIBRARY})
endif()

set_target_properties(settingsnode PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${SETTINGSNODE_INCLUDES}")
set_target_properties(settingsnode PROPERTIES IMPORTED_LINK_INTERFACE_LANGUAGES "CXX")
set_target_properties(settingsnode PROPERTIES IMPORTED_LOCATION "${SETTINGSNODE_LIBRARY}")
